...
const int CBillBoard::ANIM_FRAME = 5;//アニメーションのフレーム数
//========================
//コンストラクタ
//========================
...
void CBillBoard::TexMove()
{
	...
	//テクスチャ座標の更新	
	pVtx[0].tex = D3DXVECTOR2(0.0f + m_PosTexV, 0.0f);
	pVtx[1].tex = D3DXVECTOR2(1.0f + m_PosTexV, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(0.0f + m_PosTexV, 1.0f);
	pVtx[3].tex = D3DXVECTOR2(1.0f + m_PosTexV, 1.0f);
